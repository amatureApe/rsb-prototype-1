...
const BondInput = ({ handleBondInput, bondToken }) => {
    return (
        <Box bg="rgba(255, 73, 147, 0.2)" borderRadius={10}>
            <Stack direction="column" h={135} p={2} borderRadius={10} justify="center">
                <Box px={5}>
                    ...
                    <Input bg="whiteAlpha.800" color="#525252" borderWidth="1px" borderColor="#FF4993" _placeholder={{ color: "#525252" }} placeholder="Collateral token address" />
                    <RadioGroup onChange={handleBondInput} value={bondToken}>
